...
config.active_mq.batch_source_queue = process.env.ACTIVEMQ_BATCH_SOURCE_QUEUE || '/queue/test';
config.active_mq.batch_target_queue = process.env.ACTIVEMQ_BATCH_TARGET_QUEUE || '/queue/LaunchPointProcess_Processes_Core_CaseManagement_Case_Manager_Queue_Service';

config.active_mq.request_source_queue = process.env.ACTIVEMQ_REQUEST_SOURCE_QUEUE || '/queue/iso_request';
config.active_mq.request_target_queue = process.env.ACTIVEMQ_REQUEST_TARGET_QUEUE || '/queue/LaunchPointProcess_Processes_Core_ProcessISOCase_Process_ISO_Case_DCM';

config.active_mq.score_source_queue = process.env.ACTIVEMQ_SCORE_SOURCE_QUEUE || '/queue/iso_score';
config.active_mq.score_target_queue = process.env.ACTIVEMQ_SCORE_TARGET_QUEUE || 'LaunchPointProcess_Processes_Core_ProcessISOResponse_ISO_Response_Manager_DCM';
